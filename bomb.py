...
def check_number():
    ...
    try:
        ...
        if phone.startswith("0") or phone.startswith("+", 1):
            ...
            print(
                Fore.RED + Style.BRIGHT + "Error incorrect number!" + Style.RESET_ALL
            )
            exit()
    except Exception:
        print(Fore.RED + Style.BRIGHT + "Error incorrect number!" + Style.RESET_ALL)
        exit()
...
def start():
    ...
    while iteration < count:
        ...
        try:
            ...
            print(nice + "SportMaster, BelkaCar sent successfully!" + Style.RESET_ALL)
        except:
...
def menu():
    ...
    print(banner + Style.RESET_ALL)
    print(Fore.GREEN + '-------------------------------')
    print(Fore.GREEN + '''Created by ELVIN translated and modified by Quessts\nTelegram: @SmsBomber_AK47 and @Quessts\nversion 0.0.10''')
    print('-------------------------------')
    global phone
